...
/***/ function (module, exports) {
            ...
            */
            ...
            function dropdownMultiselectController($scope, $element, $filter, $document) {
                ...
                var texts = {
                    checkAll: abp.localization.localize("CheckAll", "Organizer"),
                    uncheckAll: abp.localization.localize("UncheckAll", "Organizer"),
                    selectionCount: 'checked',
                    selectionOf: '/',
                    searchPlaceholder: abp.localization.localize("Search", "Organizer")+"...",
                    buttonDefaultText: abp.localization.localize("Select", "Organizer"),
                    dynamicButtonTextSuffix: 'checked',
                    disableSearch: 'Disable search',
                    enableSearch: 'Enable search',
                    selectGroup: abp.localization.localize("SelectAll", "Organizer"),
                    allSelectedText: abp.localization.localize("All", "Organizer")
                };
